...
def retrieve_dataforfetchnew(username, email, WMusername):
    ...
    blob_name = f"forWMconcole/pdfforreal/linkfilesforeachwm/{WMusername}/{key}.enc"
    ...
    print("Xxxxxxxs---s-----------------------------xxxxxxxxxxxxx")
    return df